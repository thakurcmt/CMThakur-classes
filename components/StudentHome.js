...
EduApp.StudentHome = {
        ...
        submitBtn.addEventListener('click', () => {
            if (selectedFile) {
                ...
                reader.onload = (e) => {
                    ...
                    try {
                        const success = EduApp.db.submitHomework(
                            homeworkItem.id, 
                            selectedFile.name, 
                            fileSizeKb,
    ...
    showJoinBatchModal(studentId) {
        ...
        modal.querySelector('#join-batch-form').addEventListener('submit', (e) => {
            e.preventDefault();
            ...
            const success = EduApp.db.createJoinRequest(studentId, batchId);
            if (success) {
