...
EduApp.TeacherHome = {
        ...
        pendingRequests.forEach(req => {
            ...
            if (approveBtn) {
                approveBtn.addEventListener('click', () => {
                    const success = EduApp.db.approveJoinRequest(req.id);
                    if (success) {
            ...
            if (rejectBtn) {
                rejectBtn.addEventListener('click', () => {
                    const success = EduApp.db.rejectJoinRequest(req.id);
                    if (success) {
    ...
    showCreateBatchModal() {
        ...
        modal.querySelector('#create-batch-form').addEventListener('submit', (e) => {
            e.preventDefault();
            ...
            // Call db write
            EduApp.db.addClass(batchPayload);
    ...
    showDraftTestModal() {
        ...
        modal.querySelector('#draft-test-form').addEventListener('submit', (e) => {
            e.preventDefault();
