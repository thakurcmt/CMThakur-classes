...
file_path = r"C:\Users\thaku\OneDrive\Desktop\edu-platform\components\StudentHome.js"

with open(file_path, "r", encoding="utf-8") as f:
    content = f.read()

# Let's find launchClassroomSimulator(activeClass) and replace it down to the next method launchHomeworkViewer(hw)
# We can find the start of launchClassroomSimulator(activeClass) and the start of launchHomeworkViewer(hw)

start_marker = "    // Classroom simulator logic (popups/simulations)\n    launchClassroomSimulator(activeClass) {"
end_marker = "    // View submitted student homework PDF\n    launchHomeworkViewer(hw) {"
...
# The new implementation of launchClassroomSimulator
new_impl = """    // Classroom simulator logic (popups/simulations)
    launchClassroomSimulator(activeClass) {
